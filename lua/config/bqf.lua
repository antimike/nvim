-- @Summary Customize quickfix border highlights
-- @Description Example customization suggested on GH homepage under "Advanced Configuration"
local function customize_qf_borders()
	vim.cmd([[
...
-- @Summary Customize quickfix highlights
-- @Description Example customization suggested on GH homepage under "Highlight Groups"
local function customize_qf_highlights()
	vim.cmd([[
...
require("bqf").setup(suggested_config)
